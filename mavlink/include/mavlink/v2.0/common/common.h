...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_AVIATA_FINALIZE_DOCKING=43001, /* Configure the mixer once docked based on the docking slot and the missing drones. Also update PID values, flight controller orientation, etc. |1-indexed docking slot| 1-indexed slot number of 1st missing drone, or 0 if not missing| 1-indexed slot number of 2nd missing drone, or 0 if not missing| 1-indexed slot number of 3rd missing drone, or 0 if not missing| 1-indexed slot number of 4th missing drone, or 0 if not missing| 1-indexed slot number of 5th missing drone, or 0 if not missing| 1-indexed slot number of 6th missing drone, or 0 if not missing|  */
   MAV_CMD_AVIATA_SET_CONFIGURATION=43002, /* Update the mixer according to which drones are missing. |Reserved (default:0)| 1-indexed slot number of 1st missing drone, or 0 if not missing| 1-indexed slot number of 2nd missing drone, or 0 if not missing| 1-indexed slot number of 3rd missing drone, or 0 if not missing| 1-indexed slot number of 4th missing drone, or 0 if not missing| 1-indexed slot number of 5th missing drone, or 0 if not missing| 1-indexed slot number of 6th missing drone, or 0 if not missing|  */
